...
if menu == "🗺️ Ver Mapa":
    ...
    for _, row in df_mapa.iterrows():
        ...
        # CORRECCIÓN LÍNEA 74: Nombre del icono con comillas correctas
        folium.Marker(
            [row['LAT'], row['LON']], 
            ...
            if st.form_submit_button("✅ Guardar"):
                if nombre:
                    try:
                        ...
                        # GUARDADO: Intentamos actualizar la hoja
                        ...
                        st.error("No se pudo escribir. ¿Está el Excel en modo EDITOR?")
                        st.info(f"Error: {e}")
                else:
